## Project description
Would You Rather? is a browser-based game whereby users can upload and answer questions that have exactly two possible answers. Assume the identity of your favorite programmer personality and start playing!

To get started with development or to demo the application, run 'npm install' followed by 'npm start' at a terminal pointing to the root directory of this project. 
